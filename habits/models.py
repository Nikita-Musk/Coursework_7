...
class Habit(models.Model):
    FREQ_CHOICES = [("minutes", "Минуты"), ("hours", "Часы"), ("days", "Дни")]
    ...
    frequency_in = models.PositiveIntegerField(verbose_name="Повторение привычки в")
    reward = models.CharField(
        max_length=150, verbose_name="Награда", blank=True, null=True
    )
